...
public class PDFTextStripper extends PDFStreamEngine
{
     ...
     * @throws IOException if something went wrong
     */
    public void writeLine(List<TextPosition> lineTP, boolean isRtlDominant, boolean hasRtl)throws IOException
    {
        List<String> line = normalize(lineTP, isRtlDominant, hasRtl);
